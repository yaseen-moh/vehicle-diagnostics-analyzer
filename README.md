...
**[Try the live demo →](./demo/index.html)** (adjust the cascading-failure mileage window and minimum-systems threshold live, click any vehicle to drill into its repair timeline, browse/filter the full ticket table, or upload your own repair-ticket CSV — entirely client-side. No install needed.)
